	...
	methods = {
        init: function (options) {
           	return this.each(function() {
                ...
                $(opt.box).hide(); //隐藏容器
				$this.on(opt.triggerEvent,function(event) { //元素点击事件
        ...
        add: function (o,$this) { //显示弹框
			...
			if(o.title != ''){ $obj.stop().prepend('<div id="HTitle" style="padding:10px 45px 10px 12px;border-bottom:1px solid #ddd;background-color:#f2f2f2;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">'+o.title+'</div><div class="HBoxMain"></div>'); }
			...
			$(o.box).find(".HBoxMain").html("");
			$(o.box).find(".HBoxMain").load(o.url);
        },
